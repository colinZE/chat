...
const (
	...
	Chat_RCTokenLogin_FullMethodName            = "/openim.chat.chat/RCTokenLogin"
)
...
type ChatClient interface {
	...
	RCTokenLogin(ctx context.Context, in *RCTokenLoginReq, opts ...grpc.CallOption) (*RCTokenLoginResp, error)
}
...
func (c *chatClient) RCTokenLogin(ctx context.Context, in *RCTokenLoginReq, opts ...grpc.CallOption) (*RCTokenLoginResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RCTokenLoginResp)
	err := c.cc.Invoke(ctx, Chat_RCTokenLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServer interface {
	...
	RCTokenLogin(context.Context, *RCTokenLoginReq) (*RCTokenLoginResp, error)
...
func (UnimplementedChatServer) RCTokenLogin(context.Context, *RCTokenLoginReq) (*RCTokenLoginResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RCTokenLogin not implemented")
}
...
func _Chat_RCTokenLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RCTokenLoginReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).RCTokenLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_RCTokenLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).RCTokenLogin(ctx, req.(*RCTokenLoginReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Chat_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RCTokenLogin",
			Handler:    _Chat_RCTokenLogin_Handler,
		},
	},
