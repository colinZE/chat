...
type RCTokenLoginReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Source        string                 `protobuf:"bytes,1,opt,name=source,proto3" json:"source"`      // 来源标识，如"ai_rc"
	Token         string                 `protobuf:"bytes,2,opt,name=token,proto3" json:"token"`        // 瑞承token
	Platform      int32                  `protobuf:"varint,3,opt,name=platform,proto3" json:"platform"` // 平台类型（必需）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RCTokenLoginReq) Reset() {
	*x = RCTokenLoginReq{}
...
func (x *RCTokenLoginReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RCTokenLoginReq) ProtoMessage() {}

func (x *RCTokenLoginReq) ProtoReflect() protoreflect.Message {
	mi := &file_chat_chat_proto_msgTypes[47]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RCTokenLoginReq.ProtoReflect.Descriptor instead.
func (*RCTokenLoginReq) Descriptor() ([]byte, []int) {
	return file_chat_chat_proto_rawDescGZIP(), []int{47}
}

func (x *RCTokenLoginReq) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *RCTokenLoginReq) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *RCTokenLoginReq) GetPlatform() int32 {
	if x != nil {
		return x.Platform
	}
	return 0
...
func (x *RCTokenLoginResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RCTokenLoginResp) ProtoMessage() {}

func (x *RCTokenLoginResp) ProtoReflect() protoreflect.Message {
	mi := &file_chat_chat_proto_msgTypes[48]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RCTokenLoginResp.ProtoReflect.Descriptor instead.
func (*RCTokenLoginResp) Descriptor() ([]byte, []int) {
	return file_chat_chat_proto_rawDescGZIP(), []int{48}
}

func (x *RCTokenLoginResp) GetChatToken() string {
	if x != nil {
		return x.ChatToken
	}
	return ""
...
func (x *RCTokenLoginResp) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *RCTokenLoginResp) GetExpireTimeSeconds() int64 {
	if x != nil {
...
const file_chat_chat_proto_rawDesc = "" +
	...
	"\x0fRCTokenLoginReq\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05token\x12\x1a\n" +
	"\bplatform\x18\x03 \x01(\x05R\bplatform\"v\n" +
	"\x10RCTokenLoginResp\x12\x1c\n" +
	"\tchatToken\x18\x01 \x01(\tR\tchatToken\x12\x16\n" +
	"\x06userID\x18\x02 \x01(\tR\x06userID\x12,\n" +
	"\x11expireTimeSeconds\x18\x03 \x01(\x03R\x11expireTimeSeconds2\xa2\x0f\n" +
	"\x04chat\x12Q\n" +
	...
	"\x10GetAllowRegister\x12 .openim.chat.GetAllowRegisterReq\x1a!.openim.chat.GetAllowRegisterResp\x12K\n" +
	"\fRCTokenLogin\x12\x1c.openim.chat.RCTokenLoginReq\x1a\x1d.openim.chat.RCTokenLoginRespB-Z+github.com/openimsdk/chat/pkg/protocol/chatb\x06proto3"
...
var file_chat_chat_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
var file_chat_chat_proto_goTypes = []any{
	...
	(*RCTokenLoginReq)(nil),             // 47: openim.chat.RCTokenLoginReq
	(*RCTokenLoginResp)(nil),            // 48: openim.chat.RCTokenLoginResp
	nil,                                 // 49: openim.chat.FindUserAccountResp.UserAccountMapEntry
	nil,                                 // 50: openim.chat.FindAccountUserResp.AccountUserMapEntry
	nil,                                 // 51: openim.chat.UserLoginCountResp.CountEntry
	(*wrapperspb.StringValue)(nil),      // 52: openim.protobuf.StringValue
	(*wrapperspb.Int32Value)(nil),       // 53: openim.protobuf.Int32Value
	(*wrapperspb.Int64Value)(nil),       // 54: openim.protobuf.Int64Value
	(*common.UserPublicInfo)(nil),       // 55: openim.chat.common.UserPublicInfo
	(*sdkws.RequestPagination)(nil),     // 56: openim.sdkws.RequestPagination
	(*common.UserFullInfo)(nil),         // 57: openim.chat.common.UserFullInfo
}
var file_chat_chat_proto_depIdxs = []int32{
	52, // 0: openim.chat.UpdateUserInfoReq.account:type_name -> openim.protobuf.StringValue
	52, // 1: openim.chat.UpdateUserInfoReq.phoneNumber:type_name -> openim.protobuf.StringValue
	52, // 2: openim.chat.UpdateUserInfoReq.areaCode:type_name -> openim.protobuf.StringValue
	52, // 3: openim.chat.UpdateUserInfoReq.email:type_name -> openim.protobuf.StringValue
	52, // 4: openim.chat.UpdateUserInfoReq.nickname:type_name -> openim.protobuf.StringValue
	52, // 5: openim.chat.UpdateUserInfoReq.faceURL:type_name -> openim.protobuf.StringValue
	53, // 6: openim.chat.UpdateUserInfoReq.gender:type_name -> openim.protobuf.Int32Value
	53, // 7: openim.chat.UpdateUserInfoReq.level:type_name -> openim.protobuf.Int32Value
	54, // 8: openim.chat.UpdateUserInfoReq.birth:type_name -> openim.protobuf.Int64Value
	53, // 9: openim.chat.UpdateUserInfoReq.allowAddFriend:type_name -> openim.protobuf.Int32Value
	53, // 10: openim.chat.UpdateUserInfoReq.allowBeep:type_name -> openim.protobuf.Int32Value
	53, // 11: openim.chat.UpdateUserInfoReq.allowVibration:type_name -> openim.protobuf.Int32Value
	53, // 12: openim.chat.UpdateUserInfoReq.globalRecvMsgOpt:type_name -> openim.protobuf.Int32Value
	53, // 13: openim.chat.UpdateUserInfoReq.RegisterType:type_name -> openim.protobuf.Int32Value
	55, // 14: openim.chat.FindUserPublicInfoResp.users:type_name -> openim.chat.common.UserPublicInfo
	56, // 15: openim.chat.SearchUserPublicInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	55, // 16: openim.chat.SearchUserPublicInfoResp.users:type_name -> openim.chat.common.UserPublicInfo
	57, // 17: openim.chat.FindUserFullInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	...
	49, // 20: openim.chat.FindUserAccountResp.userAccountMap:type_name -> openim.chat.FindUserAccountResp.UserAccountMapEntry
	50, // 21: openim.chat.FindAccountUserResp.accountUserMap:type_name -> openim.chat.FindAccountUserResp.AccountUserMapEntry
	55, // 22: openim.chat.SignalRecord.inviterUserList:type_name -> openim.chat.common.UserPublicInfo
	56, // 23: openim.chat.SearchUserFullInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	57, // 24: openim.chat.SearchUserFullInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	51, // 25: openim.chat.UserLoginCountResp.count:type_name -> openim.chat.UserLoginCountResp.CountEntry
	56, // 26: openim.chat.SearchUserInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	57, // 27: openim.chat.SearchUserInfoResp.users:type_name -> openim.chat.common.UserFullInfo
	...
	47, // 51: openim.chat.chat.RCTokenLogin:input_type -> openim.chat.RCTokenLoginReq
	...
	48, // 74: openim.chat.chat.RCTokenLogin:output_type -> openim.chat.RCTokenLoginResp
